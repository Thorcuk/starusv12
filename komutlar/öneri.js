...
module.exports.run = async (bot, message, args, guild) => {
    ...
    const tavsiyeKanal = bot.channels.find('id', '762243172600381440'); //kanal id girin
    if(!tavsiye) return message.channel.sendEmbed(new Discord.RichEmbed().setDescription('Tavsiyeni girmedin! Doğru kullanım: `s!öneri <tavsiyeniz>`').setColor("RED"));
    ...
    message.channel.sendEmbed(new Discord.RichEmbed().setColor("GREEN").setDescription('Tavsiyeniz başarıyla [destek sunucumuza](https://discord.gg/5u5xqDH) gönderildi! ✅'));
})};
